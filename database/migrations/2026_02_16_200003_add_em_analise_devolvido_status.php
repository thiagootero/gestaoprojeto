...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE etapas_prestacao MODIFY COLUMN status ENUM('pendente','em_elaboracao','enviada','aprovada','com_ressalvas','rejeitada','em_analise','realizado','devolvido') DEFAULT 'pendente'");
    }

    public function down(): void
    {
        DB::statement("ALTER TABLE tarefas MODIFY COLUMN status ENUM('a_iniciar','em_andamento','concluido','nao_realizado','cancelado','realizado','em_analise') DEFAULT 'a_iniciar'");
